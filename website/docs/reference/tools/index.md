...
- **[`bake_ugui`](./core/bake_ugui.md)** — Bake UGUI prefabs from UI-DSL HTML via the built-in UguiBake pipeline.
- **[`bake_vfx`](./core/bake_vfx.md)** — Bake particle VFX prefabs from VFX-DSL JSON via the built-in VfxBake pipeline.
